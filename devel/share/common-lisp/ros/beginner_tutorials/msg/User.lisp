...
(cl:defmethod cl:initialize-instance :after ((m <User>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'User)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<User> is deprecated: use beginner_tutorials-msg:User instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <User>))
...
(cl:defmethod last_name-val ((m <User>))
